...
\begin{lemma}[Degree-invariance from coefficient order-invariance]
  ...
  \leanok
  \uses{def:DegreeInvariant, def:OrderInvariantMv, def:NotIdenticallyZeroOn}
...
\begin{proof}
  ...
  Since $F_i$ is not identically zero on $S$, Lemma~\ref{lem:degree_invariant_of_coeff_order_invariant}
